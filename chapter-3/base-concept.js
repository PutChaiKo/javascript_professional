...
// 3.4 数据类型
    ...
    // 3.4.5 number
        ...
        var num1 = Number("Hello World!"),  // NaN
            num2 = Number(""),              // 0
            num3 = Number("000011"),        // 11
            num4 = Number(true),            // 1
            num5 = parseInt("1234blue"),    // 1234
            num6 = parstInt(""),            // NaN
            num7 = ParseInt("0xA"),         // 10
            num8 = ParseInt(22.5),          // 22
            num9 = ParseInt("070"),         // 56（八进制）
            num10 = ParseInt("70"),         // 70
            num11 = ParseInt("0xf"),        // 15
            num12 = parseInt("0xAF",16),    // 175,16为转换基数，代表多少进制
            num13 = parseInt("AF",16),      // 175，与上述等价
            num14 = parseInt("AF"),         // NaN
            num15 = parseInt("10",2),       // 2
            num16 = parseInt("10",8),       // 8
            num17 = parseInt("10",10),      // 10
            num18 = parseInt("10",16),      // 16
            num19 = parseFloat("1234blue"), // 1234
            num20 = parseFloat("0xA"),      // 0,只支持十进制
            num21 = parseFloat("22.5"),     // 22.5
            num22 = parseFloat("22.34.5"),  // 22.34
            num23 = parseFloat("3.125e7");  // 31250000
    ...
    // 3.4.6 string
        ...
        var age = 11,
            ageAsString = age.toString(),    // "11"
            found = true,
            foundAsString = found.toString();    // true
...
// 3.5 操作符
    ...
    // 3.5.2 位操作符
        ...
        var num1 = 25,      // 00000000000000000000000000011001
            num2 = ~num1;   // 11111111111111111111111111100110
        console.log(num2);  // -26
        // 按位与（AND）
        var result = 25 & 3;
        ...
        var oldValue = 2,               // 二进制 10
            newValue = oldValue << 5;   // 二进制1000000，64
        // 有符号的右移
        var oldValue = 64,
            newValue = oldValue >> 5;   // 2
        // 无符号右移
        var oleValue = 64,              // 1000000
            newValue = oldValue >>> 5;  // 10,2

        var oleValue = -64,              // 11111111111111111111111111000000
            newValue = oldValue >>> 5;  // 00000111111111111111111111111110，134217726
    ...
    // 3.5.3 布尔操作符
        ...
        // 逻辑与属于短路操作，见下例
        var found = true,
            result = (found && someUndefinedVariable);      // 后一变量位声明，错误
        console.log(result);    // 这一行不会执行

        var found = false,
            result = (found && someUndefinedVariable);      // 不会错误
        ...
        // 同为短路操作
        var found = true,
            result = (found || someUndefinedVariable);      // 不会发生错误
        console.log(result);    // 输出“true”

        var found = false,
            result = (found || someUndefineVariable);       // 错误
        console.log(result);    // 不执行

        // 可利用逻辑非来避免为变量赋 null或 undefined
        ...
        var result1 = 5 - true,    // 4,Number(null)
            result2 = NaN - 1,     // NaN,涉及到NaN都返回这个
            result3 = 5 - 3,        // 2
            result4 = 5 - "",       // 5,Number(null),""转换为0
            result5 = 5 - "2",      // 3,Number(null)
            result6 = 5 - null;     // 5,Number(null)为0
    ...
    // 3.5.6 < > <= >=
        ...
        var result = "23" < "3",    // true,"2"编码为50，"3"编码为51
            result = "23" < 3,      // false,"23"被转化为数值23，因为数值3存在
            result = "a" < 3;       // false,"a"被转化为了NaN
    ...
    // 3.5.7 == != ===
        ...
        var result1 = (null == undefined),      // true
            result2 = ("NaN" == NaN),           // false
            result3 = (5 == NaN),               // false
            result4 = (NaN == NaN),             // false
            result5 = (NaN != NaN),             // true
            result6 = (false == 0),             // true
            result7 = (true == 1),              // true
            result8 = (true == 2),              // false
            result9 = (undefined == 0),         // false
            result10 = (null == 0),             // false
            result11 = ("5" == 5);              // false

        // 全等 不全等 === !==
        var result1 = ("55" == 55),          // true,转换
            result2 = ("55" === 55),         // false,数据类型不同
            result3 = ("55" != 55),          // false
            result4 = ("55" !== 55),         // true
            result5 = (null === undefined);  // 两值类似但不同类型
...
// 3.6 语句
    // 3.6.1 if
        ...
        // condition表达式求值结果未必是布尔值，会调用 Bollean() 转换结果
...
// 3.7 函数
        ...
        // 示例4，可拥有多个retune
        function diff(num1, num2)   // 该函数用于获取两个数值之间的差
        {
            if (num1 < num2)
        {
                retune num2 - num1;
